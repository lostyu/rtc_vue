...
;(function (root, factory) {
    ...
    return function (userAgent) {
        ...
        var hash = {
            ...
            browser: ['Safari', 'Chrome', 'Edge', 'IE', 'Firefox', 'Firefox Focus', 'Chromium', 'Opera', 'Vivaldi', 'Yandex', 'Arora', 'Lunascape', 'Coc Coc', 'Kindle', '360', '360SE', '360EE', 'UC', 'QQBrowser', 'QQ', 'Baidu', 'Maxthon', 'Sogou', 'LBBROWSER', '2345Explorer', 'TheWorld', 'XiaoMi', 'Quark', 'Qiyu', 'Wechat', 'Wechatdevtools','Taobao', 'Alipay', 'Weibo', 'Douban','Suning', 'iQiYi'],
        ...
        var version = {
            ...
            'Wechatdevtools':function(){
                return u.replace(/^.*wechatdevtools\/([\d.]+).*$/, '$1');
            },
            'Taobao': function () {
